    ...
    <div class="container">
        <div class="table-container">
            ...
            <div class="table-content">		
                ...
                echo '	  <a class="page-link" href="T-cliente.php?pagina='.$anterior.'">&laquo;</a>';
                echo '	</li>';
                
                for ($i = 1; $i <= $numpag; $i++) {
                    if ($i == $pagina) {
                        echo '	<li class="page-item active">';
                        echo '	  <a class="page-link" href="T-cliente.php?pagina='.$i.'">'.$i.'</a>';
                        echo '	</li>';						
                    } else {
                        echo '	<li class="page-item"><a class="page-link" href="T-cliente.php?pagina='.$i.'">'.$i.'</a></li>';
                    }
                }
                
                echo '	<li class="page-item ">';
                echo '	  <a class="page-link" href="T-cliente.php?pagina='.$siguiente.'">&raquo;</a>';
                echo '	</li>';
                echo '  </ul>';
