      ...
      <div class="container">
        <div class="row text-center">
		      <div class="text-center mx-auto col-10">
               <h2> LISTA DE PROYECTOS POR TAREAS </h2>	
            </div>
		   </div>		
		</div>	
		<div class="row text-center">	
           ...
           echo '	  <a class="page-link" href="V-vw_proyectosporcliente.php?pagina='.$anterior.'">&laquo;</a>';
           echo '	</li>';
           
           for ($i = 1; $i <= $numpag; $i++) {
               if ($i == $pagina) {
                   echo '	<li class="page-item active">';
                   echo '	  <a class="page-link" href="V-vw_proyectosporcliente.php?pagina='.$i.'">'.$i.'</a>';
                   echo '	</li>';						
               } else {
                   echo '	<li class="page-item"><a class="page-link" href="V-vw_proyectosporcliente.php?pagina='.$i.'">'.$i.'</a></li>';
               }
           }
           
           echo '	<li class="page-item ">';
           echo '	  <a class="page-link" href="V-vw_proyectosporcliente.php?pagina='.$siguiente.'">&raquo;</a>';
           echo '	</li>';
           echo '  </ul>';
