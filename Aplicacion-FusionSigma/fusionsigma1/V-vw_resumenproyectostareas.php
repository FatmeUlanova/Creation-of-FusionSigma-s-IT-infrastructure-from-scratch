      ...
      <div class="container">
        <div class="row text-center">
		      <div class="text-center mx-auto col-10">
               <h2> RESUMEN DE PROYECTOS POR TAREAS </h2>	
            </div>
		   </div>		
		</div>	
		<div class="row text-center">	
			<div class="text-center mx-auto col-10">		
               ...
               $tabla="vw_resumenproyectostareas";// Escribir entre comillas el nombre de la tabla a listar
           ...
           echo '	  <a class="page-link" href="V-vw_resumenproyectostareas.php?pagina='.$anterior.'">&laquo;</a>';
           echo '	</li>';
           
           for ($i = 1; $i <= $numpag; $i++) {
               if ($i == $pagina) {
                   echo '	<li class="page-item active">';
                   echo '	  <a class="page-link" href="V-vw_resumenproyectostareas.php?pagina='.$i.'">'.$i.'</a>';
                   echo '	</li>';						
               } else {
                   echo '	<li class="page-item"><a class="page-link" href="V-vw_resumenproyectostareas.php?pagina='.$i.'">'.$i.'</a></li>';
               }
           }
           
           echo '	<li class="page-item ">';
           echo '	  <a class="page-link" href="V-vw_resumenproyectostareas.php?pagina='.$siguiente.'">&raquo;</a>';
           echo '	</li>';
           echo '  </ul>';
